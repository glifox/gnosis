...
export class Icon extends WidgetType {
  constructor(public name: string, private svg: string) { super() }
  toDOM() {
    const span = document.createElement("span")
    span.classList.add(`cm-icon-${this.name}`)
