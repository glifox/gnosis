import {ViewPlugin, ViewUpdate, type DecorationSet, type PluginSpec, type PluginValue} from "@codemirror/view";
...
export const visibleNodes = ( view: EditorView, iterator: {
...
export const PluginFactory = <T/*, Y extends PluginValue */>(
  func: (view: EditorView, config?: T) => DecorationSet,
  conf?: T,
  // pluginSpec?: PluginSpec<Y>
) => {
